...
const config = {
	...
	controls: {
		...
		joystickLocked: true,
		buttonsLocked: false,
		init: (scene, hud, player) => {
			config.controls.buttonsLocked = true;
			Controller.init(scene, hud, player);
		}
	},
	gameData: {
		currentUsers : 0,
	...
	//-------------------------------------------------------------------------MOBILE
		...
		{ 
			config.textInstruction.setText("use the virtual joystick to move \n Press the button to interact");
			config.instructionText.setText("Press interact to continue", {
	...
	//-------------------------------------------------------------------DESKTOP
			config.textInstruction.setText("Press space bar or interact to continue");
			config.instructionText.setText("WASD or arrows to move \n Spacebar or Enter to interact");
		}
	},
	resetGame: function() 
	{
